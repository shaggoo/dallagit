            ...
            return {
                ...
                link: function(scope, element, attrs, ngModel) {
                    ...
                    popupPromise.then(function(el){
                        ...
                        scope.selectLocation = function(location, scope){
							//alert(JSON.stringify(location));
							$rootScope.location = location;
							$rootScope.location.geometry.location = location.geometry.location;
							$rootScope.location.formatted_address = location.formatted_address;
